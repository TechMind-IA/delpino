    ...
    >
      <div className="relative w-full overflow-hidden bg-muted">
        ...
        <Image
          ...
          className={`block w-full h-auto transition-all duration-500 ease-out ${loaded ? "opacity-100" : "opacity-0"} group-hover:scale-[1.04]`}
          onLoad={handleLoad}
        />
      </div>
      <div className="px-4 py-3">
        <p className="text-[13px] uppercase tracking-[0.18em] text-muted-foreground sm:text-[0.7rem]">
          {item.category}
        </p>
